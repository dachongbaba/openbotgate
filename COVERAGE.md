...
| 指标 | 覆盖率 | 已覆盖 / 总数 |
|------|--------|----------------|
| 语句 (Statements) | 65.07% | 775 / 1191 |
| 分支 (Branches)   | 44.19% | 198 / 448 |
| 函数 (Functions)  | 51.90% | 109 / 210 |
| 行 (Lines)        | 68.05% | 750 / 1102 |
...
| handler/commands/shell.ts | 79.03% | 54.16% | 85.71% | 79.66% |
...
| handler/parse.ts | 100.00% | 100.00% | 100.00% | 100.00% |
...
| runtime/sessionManager.ts | 77.27% | 83.33% | 72.72% | 76.56% |
